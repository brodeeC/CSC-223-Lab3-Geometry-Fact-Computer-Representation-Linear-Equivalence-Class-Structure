...
class SegmentNodeTest {
	...
	/**
	 * Test that a SegmentNode is properly constructed
	 * by taking to points 
	 */
	@Test
	...
	/**
	 * Test to see if the two segments are same and if the object is a
	 * valid segment 
	 */
	@Test
	void testbooleanEquals() {
		...
		assertFalse("Segments are the same", segment1.equals(segment2));
		

	}
	
	/**
	 * Test that the string will append both PointNodes and return that
	 * given segment
	 */
	@Test
	void testToString() {
