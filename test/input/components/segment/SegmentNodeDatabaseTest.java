...
class SegmentNodeDatabaseTest
{
	...
	/**
	 * Test that the SegmentNode database is properly constructed with a 
	 * map and set.
	 */
	@Test
	...
	/**
	 * Test that the adjacencylist method when called adds the point to a list of points. 
	 */
	@Test
	void testAdjacencyList() {
		...
		db.addAdjacencyList(a, point);
		db.addAdjacencyList(b, point);
		db.addAdjacencyList(c, point);
	 ...
	 * Then changes one SegmentNode in the second database and confirms they are different.
	 */
	@Test
