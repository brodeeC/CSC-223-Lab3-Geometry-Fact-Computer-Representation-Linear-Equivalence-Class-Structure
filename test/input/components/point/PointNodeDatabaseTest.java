...
class PointNodeDatabaseTest {
	...
	/**
	 * Test to properly see that the constructor properly
	 * constructs a point node.
	 */
	@Test
	...
	/**
	 * Test to see that if  the point node is contained within the 
	 * the PointNodeDatabase
	 */
	@Test
	...
	/**
	 * Test to see that if the point has a name it is returned along with
	 * if the point does not have a name the point is given the name _UNAMED
	 */
	@Test
	...
	/**
	 * Test to ensure that when getPoint is called the point is properly
	 * retrieved
	 */
	@Test
